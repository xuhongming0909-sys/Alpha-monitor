...
6. **Specification Quality Validation**: After writing the initial spec, validate it against quality criteria:
   ...
   a. **Create Spec Quality Checklist**: Generate a checklist file at `FEATURE_DIR/核对清单/需求核对清单.md` using the checklist template structure with these validation items:
