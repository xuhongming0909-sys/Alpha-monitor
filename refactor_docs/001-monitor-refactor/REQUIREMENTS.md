...
- `ATR系数 = abs(-premiumRate) / ATR百分比`
- `抛压系数 = stockAvgTurnoverAmount20Yi / remainingSizeYi`
- `加权折价率 = (-premiumRate) * atrCoefficient * sellPressureCoefficient * boardCoefficient`
