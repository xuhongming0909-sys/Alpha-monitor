...
SECRET_ENV_PATHS = [
    ...
    (("data_fetch", "plugins", "lof_iopv", "jisilu_cookie"), "JISILU_COOKIE"),
    (("data_fetch", "plugins", "lof_iopv", "firecrawl_api_url"), "FIRECRAWL_API_URL"),
    (("data_fetch", "plugins", "lof_iopv", "firecrawl_api_key"), "FIRECRAWL_API_KEY"),
]
