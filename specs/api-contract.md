---
name: api-contract
description: Dashboard API 端点合约定义
type: spec
---
...
This contract records the active dashboard-facing endpoints for the `001-monitor-refactor` feature. The dashboard should prefer reusing these interfaces and lightweight presentation shaping instead of adding heavy dashboard-only data paths.
...
- Purpose: Provide lightweight cache/status metadata for minute polling without forcing a full table reload.
- Query:
