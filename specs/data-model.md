---
name: data-model
description: Alpha Monitor Dashboard 数据模型定义
type: spec
---
...
- Rules:
  ...
  - `historyCount` may remain in payload but should not become a visible main table column unless the spec changes
