...
const rights = read('ui/src/components/RightsIssueCardList.jsx');
...
// 抢权配售三阶段存在
assert.ok(/riApply.*riAmbush.*riWait|inApplyStage/.test(rights), 'App should have 3 stages (apply/ambush/wait)');
