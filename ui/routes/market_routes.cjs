// AI-SUMMARY: 市场行情 API 路由：/api/market/* 端点定义
...
function registerMarketRoutes(options = {}) {
  ...
  registerDatasetRoute("/api/market/convertible-bond-arbitrage", "cbArb", [], (_req, force) => ({ force }));
  ...
  registerDatasetRoute("/api/market/lof-arbitrage", "lofArb", { groups: [], defaultGroup: "index", rows: [], limitedMonitorRows: [], unlimitedMonitorRows: [], sourceSummary: {}, rebuildStatus: {} }, (_req, force) => ({ force }));
